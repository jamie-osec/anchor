...
Anchor binaries are available via an NPM package [`@anchor-lang/cli`](https://www.npmjs.com/package/@anchor-lang/cli). Only `x86_64` Linux is supported currently, you must build from source for other OS'.
